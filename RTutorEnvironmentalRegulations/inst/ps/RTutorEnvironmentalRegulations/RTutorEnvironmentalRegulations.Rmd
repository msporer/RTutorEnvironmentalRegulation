...
#! addon__quiz__Change in pollution
...
#! addon__quiz__Attainment status
...
#! addon__quiz__Regression output 1
...
```{r "3__14",results='asis', output='htmlwidget', widget='leaflet', optional=TRUE}
area.map()
```
...
#! addon__quiz__Omitted variables
...
```{r "4_2__6",results='asis'}
# Enter your command here

```

#! addon__quiz__Regression output 2
...
**Task:** You can enter whatever you think is needed to solve the quiz here.
```{r "4_2__7",optional=TRUE}
# Enter your command here
```

#! addon__quiz__Regression output 3
...
#! addon__quiz__Weak-Instrument test
...
```{r "5__11",results='asis'}
# Enter your command here

```


#! addon__quiz__Regression output 4
...
```{r "6__21",results='asis'}
# Enter your command here

```

#! addon__quiz__Regression output 5
...
```{r "7__2",optional=TRUE}
# Enter your command here
```

#! addon__quiz__Population density
...
#! addon__quiz__Regression output 6
...
#! addon__quiz__Control variables
...
```{r "7__16",results='asis'}
# Enter your command here

```


#! addon__quiz__Effects on the total number of housing units
...
#! addon__quiz__Income distribution 1

#! addon__quiz__Income distribution 2
